...
import type { IStrokeProps, XYPos, XYWH, RGBAColor, Paint, ISizeProps, ElementChange, RenderCategorySet } from '@zhgu/type';
...
export const mouseEventEnum = ['mousedown', 'mousemove', 'mouseup', 'drop', 'wheel', 'keydown', 'keyup', 'dblclick', 'click', 'dragstart', 'dragmove', 'dragend', 'nomoveend'];
...
export type TJsDragStartEvent = (
    collideMessage: ICollideMessage,
    positionMessage: IPositionMessage,
) => void;
